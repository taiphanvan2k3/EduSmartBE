namespace PaymentService.Commons
{
    public static class Constants
    {
        ...
        public static readonly string CONNECTION_STRING = "Host=edu-smart.postgres.database.azure.com;Database=EduSmart.PaymentService;Username=pbl6duter;Password=Edusmartk21;Trust Server Certificate=true";
